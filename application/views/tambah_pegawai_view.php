				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<?php echo form_open_multipart('pegawai/create'); ?>
								...
								<div class="form-group">
									...
									<input type="date" class="form-control" id="tanggallahir" name="tanggallahir" placeholder="Input field" ><br>
									<label for="alamat">Alamat</label>
									<textarea name="alamat" id="alamat" class="form-control" rows="3" ></textarea><br>
									<label for="">Foto</label>
									<input type="file" class="form-control" id="userfile" name="userfile" ><br>
